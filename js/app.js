...
document.getElementById("search-btn").addEventListener("click", function () {
  ...
  if (searchFeildValue == "") {
    ...
    fetch(
      `https://openapi.programming-hero.com/api/phones?search=${searchFeildValue.toLowerCase()}`
    )
      .then((res) => res.json())
...
const displayDetils = (phone) => {
  ...
  div.innerHTML = `
    ...
    <h6><span class="title">Sensors:</span id='sensors'>${phone.data.mainFeatures.sensors}</h6>
...
/* call displayPhoneInfo for all tach phone */
